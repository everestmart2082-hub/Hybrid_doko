...
class ProductFilters extends StatefulWidget {
  ...
  const ProductFilters({super.key, required this.query, required this.onApply});
...
class _ProductFiltersState extends State<ProductFilters> {
  ...
  void initState() {
    ...
    selectedSort = widget.query['sort'] ?? "createdAt-desc";
  }
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(value: "createdAt-asc", child: Text("Oldest First")),
                DropdownMenuItem(value: "price-asc", child: Text("Price: Low-High")),
                DropdownMenuItem(value: "price-desc", child: Text("Price: High-Low")),
              ],
