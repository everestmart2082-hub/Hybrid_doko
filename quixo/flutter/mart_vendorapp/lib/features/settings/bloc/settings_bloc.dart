...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  SettingsBloc() : super(const SettingsState(theme: 'amberDark', language: 'English')) {
  ...
  FutureOr<void> _onLoadSettings(
    ...
    emit(state.copyWith(
      theme: (savedTheme != null && savedTheme.isNotEmpty) ? savedTheme : 'amberDark',
      language: (savedLanguage != null && savedLanguage.isNotEmpty) ? savedLanguage : 'English',
    ));
  }
